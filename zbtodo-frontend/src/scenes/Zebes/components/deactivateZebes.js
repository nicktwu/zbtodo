    ...
    return (
      <Toolbar className={this.props.saved ? this.props.classes.saved : this.props.numSelected > 0 ? this.props.classes.highlight : null}>
        ...
        <div className={this.props.classes.actions}>
          { this.props.saved ? null : this.props.numSelected > 0 ? <Tooltip title="Deactivate members" placement="left">
            <IconButton onClick={this.props.handleDeactivate}>
              <HighlightOffRounded />
            </IconButton>
          </Tooltip> : null}
        </div>
...
class DeactivateZebes extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default DeactivateZebes;